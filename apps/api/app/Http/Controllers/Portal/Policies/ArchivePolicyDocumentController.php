...
class ArchivePolicyDocumentController extends Controller
{
    ...
    public function __invoke(
        ...
        Gate::authorize('archive', $policyDocument);
        ...
        $recordPolicyAuditEvent->handle('archived', $policyDocument, $user);
