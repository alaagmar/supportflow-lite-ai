...
use App\Http\Requests\AuditAnalytics\ListWorkspaceAuditLogsRequest;
...
class ListWorkspaceAuditLogsController extends Controller
{
    use ResolvesWorkspaceAuditAnalyticsContext;

    public function __invoke(
        ListWorkspaceAuditLogsRequest $request,
        ...
        Gate::authorize('viewWorkspaceAudit', [AuditLog::class, $workspace]);

        /** @var array{action?: string|null, actor_user_id?: int|null, start_at?: string|null, end_at?: string|null} $validated */
        $validated = $request->validated();

        $auditLogs = $queryAuditTimeline->forWorkspace(
            user: $user,
